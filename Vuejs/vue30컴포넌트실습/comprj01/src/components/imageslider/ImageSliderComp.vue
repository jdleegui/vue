...
export default {
  ...
  methods: {
    ...
    toLeft(e) {
      ...
      debugger;
      this.$data.currIdx = this.$data.currIdx - 1;
      if (this.$data.currIdx < 0)
        this.$data.currIdx = this.$props.option.length - 1;
    },
    toRight(e) {
      ...
      // );
      this.$data.currIdx = (this.$data.currIdx + 1) % this.$props.option.length;
    },
    setActive(index) {
      debugger;
